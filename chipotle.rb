...
Can I please have a " + my_order[:style]  + ". For meat I would like " + my_order[:meat] + " with " + my_order[:rice_bean_veg] + ". Then I would like "  + my_order[:toppings][0] + ", " + my_order[:toppings][1] + " and " + my_order[:toppings][2] + ". Thank you!
